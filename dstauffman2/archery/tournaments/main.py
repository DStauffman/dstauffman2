...
from dstauffman2.archery.tournaments.constants import COL_BALE, COL_DIVISION, \
    ...
    COL_LASTNAME1, COL_LASTNAME2, COL_LASTNAME3, COL_MALE_FIRSTNAME, COL_MALE_LASTNAME, \
    COL_MALE_SCORE, COL_MALE_X_COUNT, COL_SCHOOL, COL_SCORE1, COL_SCORE2, COL_SCORE_PER1, \
    COL_SCORE_PER2, COL_SCORE_PER3, COL_SCORE_TOT, COL_SEED, COL_TEAM_NUM, COL_X_COUNT1, \
    COL_X_COUNT2, COL_X_COUNT_PER1, COL_X_COUNT_PER2, COL_X_COUNT_PER3, COL_X_COUNT_TOT, \
