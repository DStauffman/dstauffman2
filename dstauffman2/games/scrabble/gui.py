...
from dstauffman2.games.scrabble.plotting import display_tile_bag, plot_board, plot_draw_stats, plot_move_strength
...
class ScrabbleGui(QMainWindow):
    ...
    def init(self):
        ...
        self.draw_stats_axes = Axes(fig, [0.0, 0.0, 1.0, 1.0])
        ...
        self.strength_axes = Axes(fig, [0.0, 0.0, 1.0, 1.0])
