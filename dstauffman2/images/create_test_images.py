...
def draw_gradient(width: int, height: int, color_one: _C, color_two: _C, direction: str) -> Image.Image:
    """Draws a linear gradient between two colors in horizontal or vertical directions."""
    base: Image.Image = Image.new("RGB", (width, height), color_one)
    top: Image.Image = Image.new("RGB", (width, height), color_two)
    mask: Image.Image = Image.new("L", (width, height))
    mask_data = []
