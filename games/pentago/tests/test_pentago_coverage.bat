cd C:\Users\%username%\Documents\GitHub\dstauffman2\games\pentago\tests
...
start C:\Users\%username%\Documents\GitHub\dstauffman2\games\pentago\tests\coverage_html_report\index.html
