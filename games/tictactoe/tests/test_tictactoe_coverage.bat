cd C:\Users\%username%\Documents\GitHub\dstauffman2\games\tictactoe\tests
...
start C:\Users\%username%\Documents\GitHub\dstauffman2\games\tictactoe\tests\coverage_html_report\index.html
